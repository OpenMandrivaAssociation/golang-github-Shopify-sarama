...
%global commit          87ec8d76e89cc002ff5673ee7598ae1db2f32424
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        1.7.0
Release:        0.8.git%{shortcommit}%{?dist}
Summary:        Sarama is a Go library for Apache Kafka 0.8 and 0.9
License:        MIT
...
Requires:      golang(github.com/eapache/go-resiliency/breaker)
Requires:      golang(github.com/eapache/queue)
Requires:      golang(github.com/golang/snappy)
Requires:      golang(github.com/klauspost/crc32)

Provides:      golang(%{import_path}) = %{version}-%{release}
Provides:      golang(%{import_path}/mocks) = %{version}-%{release}
...
Requires:      golang(github.com/Shopify/toxiproxy/client)
...
#%%gotest %{import_path}
#%%gotest %{import_path}/examples/http_server
# panic: runtime error: invalid memory address or nil pointer dereference [recovered] on i686
#%%gotest %%{import_path}/mocks
%endif
